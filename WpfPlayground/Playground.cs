...
using System.Linq;
using System.Text;
using WpfPlayground.DesignPatterns.Behavioral;
using WpfPlayground.Projects;
...
namespace WpfPlayground
{
    public class Playground
    {
        ...
        public Playground(string _name, int _age) => (name, age) = (_name, _age);
        public void CtorInit(string _name, int age) { }

        public Playground()
        {
            new HtmlTemplateEditor().Show();
        }
    }
}
